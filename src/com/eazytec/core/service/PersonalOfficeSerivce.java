...
import com.eazytec.common.pack.PersonalOfficeHqlPack;
...
import com.eazytec.core.dao.IHrmTimedrecordDao;
import com.eazytec.core.dao.IOaLeaveregistrationDao;
import com.eazytec.core.dao.IOaNotebookDao;
import com.eazytec.core.dao.IOaToolsDao;
import com.eazytec.core.dao.IOaTrsvelDao;
...
import com.eazytec.core.pojo.OaTools;
...
public class PersonalOfficeSerivce implements IPersonalOfficeSerivce {
	...
	public void setHrmTimedrecordDao(IHrmTimedrecordDao hrmTimedrecordDao) {
		this.hrmTimedrecordDao = hrmTimedrecordDao;
	}

	public void setOaNotebookDao(IOaNotebookDao oaNotebookDao) {
		this.oaNotebookDao = oaNotebookDao;
	}

	public void setLibrayInfoDao(ISysLibraryInfoDao librayInfoDao) {
		this.librayInfoDao = librayInfoDao;
	}

	public IOaTrsvelDao getOaTrsvelDao() {
		return oaTrsvelDao;
	}

	public void setOaTrsvelDao(IOaTrsvelDao oaTrsvelDao) {
		this.oaTrsvelDao = oaTrsvelDao;
	}

	public void setOaLeaveregistrationDao(IOaLeaveregistrationDao oaLeaveregistrationDao) {
		this.oaLeaveregistrationDao = oaLeaveregistrationDao;
	}

	public void setOaToolsDao(IOaToolsDao oaToolsDao) {
		this.oaToolsDao = oaToolsDao;
	}
...
//				System.out.println(tmpcode);
	...
	public List<SysLibraryInfo> getSysLibraryInfoByCode(int companyId) {
		List<SysLibraryInfo> list = librayInfoDao.findByHqlWhere(" and model.libraryInfoUpcode = '" + ConstWords.Tool_Libriary_Code + "' and model.companyId = " + companyId
				+ " and model.libraryInfoIsvalid =" + EnumUtil.SYS_ISACTION.Vaild.value + "  order by model.libraryInfoCode");
		return list;
	}
	...
	public ProcessInstance startOaLeaveWorkflow(OaLeaveregistration oaLeaver,Map<String, Object> variables) {
	    ...
	    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey(EnumUtil.WORKFLOW_TYPE.LEAVE.key, businessKey, variables);
	...
	public ProcessInstance startOaTrsvelWorkflow(OaTrsvel oaTrsvel,Map<String, Object> variables) {
	    ...
	    ProcessInstance processInstance = runtimeService.startProcessInstanceByKey(EnumUtil.WORKFLOW_TYPE.TRSVEL.key, businessKey, variables);
	    String processInstanceId = processInstance.getId();

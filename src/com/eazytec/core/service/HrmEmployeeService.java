...
import com.eazytec.core.dao.IHrmWorkareaDao;
...
public class HrmEmployeeService implements IHrmEmployeeService {
	...
	public void setHrmWorkareaDao(IHrmWorkareaDao hrmWorkareaDao) {
		this.hrmWorkareaDao = hrmWorkareaDao;
	}
	...
	public List<HrmEmployee> getAllEmployee(HrmEmployee employee,long l, Pager pager) {
		List<HrmEmployee> employeeList = hrmEmployeeDao.findByHqlWherePage(HqlPack.packEmployeeQuery(employee,l)+" order by model.hrmEmployeeCode", pager);
	...
	public List<HrmEmployee> getAllEmployeeNoPager(HrmEmployee employee, long l){
		List<HrmEmployee> employeeList = hrmEmployeeDao.findByHqlWhere(HqlPack.packEmployeeQuery(employee,l)+" order by model.hrmEmployeeCode");
		return employeeList;
	}
	/**
	 * 统计人员记录数量
	...
	public int listEmployeeCount(HrmEmployee employee,long l) {
		int count = hrmEmployeeDao.findByHqlWhereCount(HqlPack.packEmployeeQuery(employee,l));
		return count;
	}
	...
	public List<HrmDepartment> getAllDepartment(HrmDepartment department,long c, Pager pager) {
		...
		List<HrmDepartment> hrmDepartment = hrmDepartmentDao.findByHqlWherePage(HqlPack.packDepartmentQuery(department,c)+" order by "+tmproder, pager);
	...
	public int listDepartmentCount(HrmDepartment department,long c) {
		int count = hrmDepartmentDao.findByHqlWhereCount(HqlPack.packDepartmentQuery(department,c));
		return count;
	}
	...
	public List<HrmPost> getAllPost(HrmPost hrmPost, int companyId, Pager pager) {
		...
		List<HrmPost> postList = hrmPostDao.findByHqlWherePage(HqlPack.packPostQuery(hrmPost,companyId)+" order by "+tmproder, pager);
	...
	public int listPostCount(HrmPost hrmPost, int companyId) {
		int count = hrmPostDao.findByHqlWhereCount(HqlPack.packPostQuery(hrmPost,companyId));
		return count;
	}
	...
	public List<HrmWorkarea> getAllWorkarea(HrmWorkarea workarea, Pager pager) {
		List<HrmWorkarea> workareaList = hrmWorkareaDao.findByHqlWherePage(HqlPack.packWorkareaQuery(workarea), pager);
	...
	public int listWorkareaCount(HrmWorkarea workarea) {
		int count = hrmWorkareaDao.findByHqlWhereCount(HqlPack.packWorkareaQuery(workarea));
		return count;
	}
	...
	public List<HrmWorkarea> getWorkarea(HrmWorkarea workarea) {
		List<HrmWorkarea> list = hrmWorkareaDao.findByHqlWhere(HqlPack.packWorkareaQuery(workarea));
		return list;
	}
	...
	public List<HrmEmployee> getAllEmployee_post(HrmEmployee employee,
			Pager pager) {
		List<HrmEmployee> employeelist = hrmEmployeeDao.findBySqlPage(HqlPack.getEmployeeSql(employee)+" order by emp.hrm_employee_code",HrmEmployee.class,pager);
	...
	public int listEmployeeCount_post(HrmEmployee employee) {
		return hrmEmployeeDao.findBySqlCount(HqlPack.getEmployeeSql(employee));
	}

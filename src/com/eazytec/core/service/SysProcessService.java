...
import com.eazytec.common.pack.SystemPack;
import com.eazytec.common.pages.Pager;
import com.eazytec.common.util.EnumUtil;
import com.eazytec.common.util.StringTool;
...
import com.eazytec.core.dao.ISysColumnControlDao;
...
import com.eazytec.core.dao.ISysLibraryStandardDao;
import com.eazytec.core.dao.ISysLogDao;
import com.eazytec.core.dao.ISysMethodHelpDao;
import com.eazytec.core.dao.ISysMethodInfoDao;
import com.eazytec.core.dao.ISysMethodShortcutDao;
...
public class SysProcessService implements ISysProcessService {
    ...
    public void setSysMethodShortcutDao(ISysMethodShortcutDao sysMethodShortcutDao){
       this.sysMethodShortcutDao = sysMethodShortcutDao;
    }
	...
	public void setSysRoleDetailDao(ISysRoleDetailDao sysRoleDetailDao) {
		this.sysRoleDetailDao = sysRoleDetailDao;
	}

	public void setSysRoleBindDao(ISysRoleBindDao sysRoleBindDao) {
		this.sysRoleBindDao = sysRoleBindDao;
	}
	...
	public void setHrmDeptDao(IHrmDepartmentDao hrmDeptDao) {
		this.hrmDeptDao = hrmDeptDao;
	}
	...
	public void setSysUserGroupDetailDao(ISysUserGroupDetailDao sysUserGroupDetailDao) {
		this.sysUserGroupDetailDao = sysUserGroupDetailDao;
	}
	...
	public void setSysAttachmentInfoDao(ISysAttachmentInfoDao sysAttachmentInfoDao) {
		this.sysAttachmentInfoDao = sysAttachmentInfoDao;
	}
	...
	public void setSysColumnControlDao(ISysColumnControlDao sysColumnControlDao) {
		this.sysColumnControlDao = sysColumnControlDao;
	}
	...
	public void setExceptionDao(ISysExceptionDao exceptionDao) {
		this.exceptionDao = exceptionDao;
	}
	
	public void setSysLibraryStandardDao(ISysLibraryStandardDao sysLibraryStandardDao) {
		this.sysLibraryStandardDao = sysLibraryStandardDao;
	}

	public void setSysMethodHelpDao(ISysMethodHelpDao sysMethodHelpDao) {
		this.sysMethodHelpDao = sysMethodHelpDao;
	}
	...
	public List<SysColumnControl> listAllSysColumnControl(SysColumnControl sysColumnControl) {
		return sysColumnControlDao.findByHqlWhere(HqlPack.packSysColumn(sysColumnControl));
	}

	public List<SysColumnControl> listAllSysColumnControlPager(SysColumnControl sysColumnControl, Pager pager) {
		return sysColumnControlDao.findByHqlWherePage(HqlPack.packSysColumnControlQuery(sysColumnControl), pager);
	}

	public int listAllSysColumnControlCount(SysColumnControl sysColumnControl) {
		int count = sysColumnControlDao.findByHqlWhereCount(HqlPack.packSysColumnControlQuery(sysColumnControl));
		return count;
	}
	...
	public List<SysMethodInfo> listAllSysMethodInfoPager(SysMethodInfo info,Pager pager) {
		return sysMethodInfoDao.findByHqlWherePage(HqlPack.packSysMethodInfo(info)+" order by model.primaryKey", pager);
	}

	public int listAllSysMethodInfoCount(SysMethodInfo sysMethodInfo) {
		return sysMethodInfoDao.findByHqlWhereCount(HqlPack.packSysMethodInfo(sysMethodInfo));
	}
	...
	public List<SysLibraryInfo> getSysLibraryInfoByInfo(SysLibraryInfo libraryInfo) {
		List<SysLibraryInfo> libraryList = sysLibraryInfoDao.findByHqlWhere(HqlPack.packSysLibraryInfo(libraryInfo));
		return libraryList;
	}

	public List<SysLibraryInfo> getSysLibraryInfoByInfoPager(SysLibraryInfo libraryInfo, Pager pager) {
		List<SysLibraryInfo> libraryList = sysLibraryInfoDao.findByHqlWherePage(HqlPack.packSysLibraryInfo(libraryInfo), pager);
		return libraryList;
	}

	public int getSysLibraryInfoCountByInfo(SysLibraryInfo libraryInfo) {
		int count = sysLibraryInfoDao.findByHqlWhereCount(HqlPack.packSysLibraryInfo(libraryInfo));
		return count;
	}
	...
	public SysLibraryInfo getSysLibraryInfoByCodAndCompanyId(SysLibraryInfo libraryInfo) {
		...
		List<SysLibraryInfo> list = sysLibraryInfoDao.findByHqlWhere(HqlPack.packSysLibraryInfo(libraryInfo));
		if (list.size() > 0) {
	...
	public SysLibraryInfo saveSysLibraryInfo(SysLibraryInfo libraryInfo) {
		...
		//写入其他公司
		if (libraryInfo.getPrimaryKey()==0) {
			//所有已处理公司添加参数
			List<SysCompanyInfo> companylist =  sysCompanyInfoDao.findByHqlWhere(" and model.companyInfoStatus ="+EnumUtil.SYS_COMPANY_STATUS.TAKE.value+" and model.companyInfoCode is not null and model.primaryKey <> "+info.getCompanyId());
			for (SysCompanyInfo sysCompanyInfo : companylist) {
				SysLibraryInfo lib = new SysLibraryInfo();
				lib.setCompanyId((int)sysCompanyInfo.getPrimaryKey());
				lib.setLibraryInfoCode(info.getLibraryInfoCode());
				lib.setLibraryInfoName(info.getLibraryInfoName());
				lib.setLibraryInfoEngname(info.getLibraryInfoEngname());
				lib.setLibraryInfoUpcode(info.getLibraryInfoUpcode());
				lib.setLibraryInfoDesc(info.getLibraryInfoDesc());
				lib.setLibraryInfoIsvalid(info.getLibraryInfoIsvalid());
				lib.setLibraryInfoIsedit(info.getLibraryInfoIsedit());
				sysLibraryInfoDao.save(lib);
			}
		}
		return info;
	}
	...
	public List<SysLibraryInfo> getSysLibraryInfoByCode(String code, int companyId) {
		List<SysLibraryInfo> list = sysLibraryInfoDao.findByHqlWhere(" and model.libraryInfoUpcode = '" + code + "' and model.companyId = " + companyId + " and model.libraryInfoIsvalid ="
	...
	public SysLibraryInfo getSysLibraryInfoByCodeAndCompanyId(String code, int companyId) {
		...
		List<SysLibraryInfo> list = sysLibraryInfoDao.findByHqlWhere(" and model.libraryInfoCode = '" + code + "' and model.companyId = " + companyId + "");
		if (list.size() > 0) {
			info = list.get(0);
		}
		return info;
	...
	public List<SysLibraryInfo> getSysLibraryInfoByName(String name,int companyId){
		List<SysLibraryInfo> list = sysLibraryInfoDao.findByHqlWhere(" and model.libraryInfoName = '" + name + "' and model.companyId = " + companyId + "");
		return list;
	}
	...
	public List<SysMsg> getAllSystemMsg(SysMsg msg, Pager pager) {
		List<SysMsg>  msgList = sysMsgDao.findByHqlWherePage(HqlPack.packSysMsgQuery(msg), pager);
		return msgList;
	}
	...
	public int getSystemMsgCount(SysMsg msg) {
		int count = sysMsgDao.findByHqlWhereCount(HqlPack.packSysMsgQuery(msg));
		return count;
	}
...
//////////////////////////////////////////////////
	...
	public List<SysHelp> getAllSystemHelp(SysHelp help, Pager pager) {
		List<SysHelp>  helpList = sysHelpDao.findByHqlWherePage(HqlPack.packSysHelpQuery(help), pager);
	...
	public int getSystemHelpCount(SysHelp help) {
		int count = sysHelpDao.findByHqlWhereCount(HqlPack.packSysHelpQuery(help));
		return count;
	}
	...
	public void updateSysCompanyInfo(SysCompanyInfo companyInfo,SysCompanyInfo systemInfo){
		...
		//2.初始化公司运行参数
		//2.1 初始化数据字典
		List<SysLibraryInfo> librarylist = sysLibraryInfoDao.findByHqlWhere(" and model.companyId = "+systemInfo.getPrimaryKey());
		for (SysLibraryInfo oldinfo : librarylist) {
			SysLibraryInfo newinfo = new SysLibraryInfo();
			newinfo.setLibraryInfoCode(oldinfo.getLibraryInfoCode());
			newinfo.setLibraryInfoName(oldinfo.getLibraryInfoName());
			newinfo.setLibraryInfoEngname(oldinfo.getLibraryInfoEngname());
			newinfo.setLibraryInfoUpcode(oldinfo.getLibraryInfoUpcode());
			newinfo.setLibraryInfoIsedit(oldinfo.getLibraryInfoIsedit());
			newinfo.setLibraryInfoIsvalid(oldinfo.getLibraryInfoIsvalid());
			newinfo.setLibraryInfoDesc(oldinfo.getLibraryInfoDesc());
			newinfo.setCompanyId((int)companyInfo.getPrimaryKey());
			sysLibraryInfoDao.save(newinfo);
		}
		//2.2 生成超级用户
...
//		}
   ...
   public List<SysParam> getSysparmByIdex(String task_name) {
	...
	public List<OnlineHrmEmployeeBean> getOnlineEmployee(HrmEmployee employee,long companyId, Pager pager){
		...
		List<Object[]> objlist = hrmEmployeeDao.findBySqlObjListByPager(HqlPack.packOnLineEmployeeQuery(employee, companyId)+" order by emp.hrm_employee_code", pager);
	...
	public int getOnlineEmployeeCount(HrmEmployee employee,long companyId){
		return hrmEmployeeDao.findBySqlCount(HqlPack.packOnLineEmployeeQuery(employee, companyId));
	}
	/**
	 * 获得所有在线人员
	 */
	public List<HrmEmployee> getAllEmployee(HrmEmployee employee,long companyId, Pager pager) {
		List<HrmEmployee> employeeList = hrmEmployeeDao.findByHqlWherePage(HqlPack.packEmployeeQuery(employee,companyId), pager);
	...
	public int listEmployeeCount(HrmEmployee employee, long companyId) {
		int count = hrmEmployeeDao.findByHqlWhereCount(HqlPack.packEmployeeQuery(employee,companyId));
		return count;
	}
	...
	public List<SysLibraryStandard> getSysLibraryStandardInfoPager(SysLibraryStandard libraryInfo, Pager pager) {
		List<SysLibraryStandard> libraryList = sysLibraryStandardDao.findByHqlWherePage(HqlPack.packSysLibraryStandardInfo(libraryInfo), pager);
		return libraryList;
	}
	
	public int getSysLibraryStandardCount(SysLibraryStandard libraryInfo) {
		int count = sysLibraryStandardDao.findByHqlWhereCount(HqlPack.packSysLibraryStandardInfo(libraryInfo));
		return count;
	}
	...
	public List<SysLibraryStandard> getSysLibraryStandardInfo(SysLibraryStandard libraryInfo) {
		List<SysLibraryStandard> libraryList = sysLibraryStandardDao.findByHqlWhere(HqlPack.packSysLibraryStandardInfo(libraryInfo));
		return libraryList;
	}
	...
	public int listSysMethodHelpCount(SysMethodHelp methodHelp){
		int count = sysMethodHelpDao.findBySqlCount(HqlPack.packSysMethodHelp(methodHelp));
		return count;
	}
	
	public List<SysMethodHelp> listSysMethodHelpByPager(SysMethodHelp methodHelp, Pager pager){
		List<SysMethodHelp> list = sysMethodHelpDao.findBySqlPage(HqlPack.packSysMethodHelp(methodHelp),SysMethodHelp.class,pager);
		return list;
	}
	...
	public int listSysMethodShortcutCount(SysMethodShortcut sysMethodShortcut){
      int count = sysMethodShortcutDao.findByHqlWhereCount(HqlPack.packSysMethodShortcutQuery(sysMethodShortcut));
      return count;
   }

   public List<SysMethodShortcut> listSysMethodShortcut(SysMethodShortcut sysMethodShortcut, Pager pager){
      List<SysMethodShortcut> list = sysMethodShortcutDao.findByHqlWherePage(HqlPack.packSysMethodShortcutQuery(sysMethodShortcut), pager);
      return list;
   }

package com.eazytec.web.servlet.file;
...
import com.eazytec.common.util.imgProcess.MyFileRenamePolicy;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(forward.equalsIgnoreCase("img")&&oldimg!=null&&oldimg.length()>0){
				...
				writer.print(tmp+"<script type='text/javascript'>alert('" + new String(msg.getBytes("gb2312"), "iso-8859-1") + "');\n"+back+"</script>");
			}else{
				writer.println("<script type='text/javascript'>alert('" + new String(msg.getBytes("gb2312"), "iso-8859-1") + "');history.back();</script>");
			}
			writer.close();
			return;
		}

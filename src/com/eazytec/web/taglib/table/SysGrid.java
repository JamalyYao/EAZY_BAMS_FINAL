package com.eazytec.web.taglib.table;
...
import com.eazytec.web.taglib.table.cloumntype.AbscolumnType;
import com.eazytec.web.taglib.table.cloumntype.CheckBoxType;
import com.eazytec.web.taglib.table.cloumntype.DateType;
import com.eazytec.web.taglib.table.cloumntype.GridColumnType;
import com.eazytec.web.taglib.table.cloumntype.OtherType;
import com.eazytec.web.taglib.table.cloumntype.RadioType;
import com.eazytec.web.taglib.table.cloumntype.SelectType;
import com.eazytec.web.taglib.table.cloumntype.TextType;
import com.eazytec.web.taglib.table.cloumntype.TimeType;
...
public class SysGrid {
	...
	public String createTable() {
		...
		table.append("<table width='" + tableWidth + "' cellpadding='0' cellspacing='0' class='grid_table' align ='center' height ='" + tableHeight + "' style ='table-layout:fixed;border:" + border
				+ "px solid #D8D6D6'>\n");
		table.append("<tr style='BACKGROUND-IMAGE: url(" + getPath() + "/images/grid_images/wbg.gif);'  height='30px'>\n");
		...
		if (isshowProcessTool) {
			table.append("<tr style='BACKGROUND-IMAGE: url(" + this.getPath() + "/images/grid_images/bg.gif);'  height='" + AdvancedRowHeight + "px'>\n");
			...
			if (getAdvanedCount() > 0) {
				...
				table.append("<div id='queryParam' style =\"background-color:#fff;width:100%;" + tmp + top1str + "\">\n");
			...
			if (getShowColumnCount() > 0) {
				...
				if (ptheight > 0) {
					top2str = "border-bottom:1px solid #D8D6D6";
				}
				table.append("<div id='showParam'  style =\"background-color:#fff;width:100%;" + top2str + "\">\n");
			...
			if (helpList != null && helpList.size() > 0) {// 操作提示
				...
				table.append("<div id='processTitleTable'  style =\"width:100%;background-color:#fff;text-align:left;" + tmp + "\">\n");
		...
		table.append("<div style='overflow:auto;width:100%;height:100%;' id ='allshowdiv'>\n");

		if (this.showView == SHOW_ALL || this.showView == SHOW_TABLE) {
			table.append("<div id='listShow' width='100%'>\n");
			table.append("<table width='100%' cellSpacing='0' cellPadding='0'>\n<tr>\n");// 主表格，包括行数表格和显示表格

			table.append("<td width='30px' valign='top'>\n");// 显示序号或复选框
		...
		table.append("</table>\n");
		if (this.showView == SHOW_ALL || this.showView == SHOW_IMAGE) {
			table.append("<div id=\"imgdivshow\" style=\"width:" + imgdivwidth + "px;visibility:hidden\" class ='detailDivClass'></div>\n");
		}
		table.append("<div id=\"pagesenddiv\" style=\"visibility:hidden\" class ='pagesendDivClass'>\n");
	...
	private String createProcessTable() {
		...
		processTable.append("<thead style='BACKGROUND-IMAGE: url(" + this.getPath() + "/images/grid_images/fhbg2.gif);'>\n");
		processTable.append("<TD class='tableTitle1'>&nbsp;操 作&nbsp;</TD>\n</thead>\n");
		processTable.append("<tbody></tbody>\n");
	...
	private String createMainTable() {
		...
		maintable
				.append("<TABLE class='tableStyleSolidLine' cellSpacing='0' cellPadding='4' width='100%' align='center' id='tableResult' ondrag='return false;' onmousedown='MoveTableUtil.init(this)' onmouseup='MoveTableUtil.end(this)' onmousemove='MoveTableUtil.drag(this)'>\n");
		//maintable.append("<thead style='BACKGROUND-IMAGE: url(" + this.getPath() + "/images/grid_images/fhbg2.gif);'>\n");
	...
	private String createImgProcess() {
		...
		tablecols.append("</table>");
		tablecols.append("</td>\n");
		tablecols.append("<td align='right' width ='110px' id='imgchktitle'>\n");
	...
	private String initJaveScript() {
		...
		if(this.showView==SHOW_ALL || this.showView==SHOW_TABLE){
			js.append("<script  type='text/javascript'   src='"+this.getPath()+"/js/sys_grid/trmove.js'></script>");
			js.append("<script  type='text/javascript'   src='"+this.getPath()+"/js/sys_grid/tdsort.js'></script>");
			js.append("<script  type='text/javascript'   src='"+this.getPath()+"/js/sys_grid/movetab.js'></script>");

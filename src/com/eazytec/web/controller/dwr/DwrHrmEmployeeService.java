...
import com.eazytec.common.util.office.ExportExcel;
...
public class DwrHrmEmployeeService {
	...
	/**
	 * 导出已人员信息到Excel JC 2014-02-08
	 * @param context
	 * @param request
	 * @param member
	 * @return
	 */
	public ResultBean exportEmployee(ServletContext context, HttpServletRequest request, HrmEmployee employee) {
		...
		try {
			ExportExcel.setRealPath(UtilTool.getRealPath(context));
			ExportExcel.exportEmployeeExcel(list);
		} catch (Exception e) {
			e.printStackTrace();

...
import com.eazytec.core.scheduler.TimedScheduler;
import com.eazytec.core.scheduler.job.TimedJob;
/**********************************************
...
**********************************************/
public class DwrPersonalOfficeSerivce {
	// 日志文件
	private final static Logger logger = Logger.getLogger(DwrPersonalOfficeSerivce.class);
	...
	public Map<SysLibraryInfo, ArrayList<OaTools>> listOaTools(ServletContext context, HttpServletRequest request, OaTools oaTools) {
		...
		List<SysLibraryInfo> libList = personalOfficeSerivce.getSysLibraryInfoByCode(UtilTool.getCompanyId(request));
	 ...
	 * @return
	 */
	public ResultBean superlistoaTrsvel(ServletContext context, HttpServletRequest request, OaTrsvel oaTrsvel, Pager paer) {
		List<OaTrsvel> oaTrsvellist = null;
		try {
			oaTrsvel.setCompanyId(UtilTool.getCompanyId(request));

...
import com.eazytec.common.util.imgProcess.PicCompression;
...
import com.eazytec.core.pojo.OaChatGroups;
import com.eazytec.core.pojo.OaDesktopSet;
import com.eazytec.core.pojo.OaForums;
...
import com.eazytec.web.controller.dwr.DwrCommonService;
import com.eazytec.web.controller.dwr.DwrHrmEmployeeService;
import com.eazytec.web.controller.dwr.DwrMailService;
import com.eazytec.web.controller.dwr.DwrOACompanyResourcesService;
import com.eazytec.web.controller.dwr.DwrOADesktopService;
import com.eazytec.web.controller.dwr.DwrOaCommunicationService;
import com.eazytec.web.controller.dwr.DwrOfficeResourcesService;
import com.eazytec.web.controller.dwr.DwrSysProcessService;
import com.eazytec.web.taglib.table.SysGridColumnBean;
import com.eazytec.web.taglib.table.SysGridTitleBean;
...
public class UtilTool {
	...
	public static String saveAttachments(ServletContext context, HttpServletRequest request, String fileNames) {
		WebApplicationContext webAppContext = WebApplicationContextUtils.getWebApplicationContext(context);
		DwrCommonService commonService = (DwrCommonService) webAppContext.getBean("dwrCommonService");
		List<SysAttachmentInfo> list = commonService.saveAttachmentInfo(context, request, fileNames);
		String ids = "";
	...
	public static String changeImageSize(String fileNames, int width, String changeSign) throws Exception {
		String newfilename = "";
		...
		if (fs.length > 0) {
			String oldpath = Base64.getStringFromBase64(fs[0]);
			if (fs.length > 1) {
				oldpath = Base64.getStringFromBase64(fs[1]);
			}
			try {
				newfilename = PicCompression.proceSize(oldpath, width, changeSign);
			} catch (Exception e) {
	 ...
	 * @return
	 */
	public static String getSysUserName(ServletContext context, HttpServletRequest request, String empId) {
		WebApplicationContext webAppContext = WebApplicationContextUtils.getWebApplicationContext(context);
		DwrSysProcessService sysProcessService = (DwrSysProcessService) webAppContext.getBean("dwrSysProcessService");

...
document.write('codebase="OfficeControl.cab#version=5,0,1,1" width="100%" height="100%">');
document.write('<param name="MakerCaption" value="江苏卓易信息科技有限公司">');
document.write('<param name="MakerKey" value="4C9E348B445A345421ECC653572BFB6EA2D6FEEC">');
document.write('<param name="ProductCaption" value="社区信息化平台">');
document.write('<param name="ProductKey" value="6E6705830920F9E2C1C1871EF368CA28D0D2388B">');
...
document.write('<param name="Caption" value="卓易 OFFICE文档控件">');

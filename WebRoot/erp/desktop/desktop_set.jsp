...
<td id="cancelbtn">
<btn:btn onclick="closeMDITab(window.parent.parent);" value="取 消 " imgsrc="../../images/winclose.png" title="取消桌面设置"></btn:btn>
</td>
</tr>
</table>
<%} %>
...
function repdesk(){
	...
	//Sys.load('<%=request.getContextPath()+sysconfig.getProjectView() %>');
}
</script>
</body>
</html>
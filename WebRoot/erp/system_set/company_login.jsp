...
<script type="text/javascript">
	...
	function saveCompanyInfo(){
		...
		warnArr[1] = "companyinfotitleMust";
		warnArr[2] = "companyinfoentitleMust";
		//清空所有信息提示
		warnInit(warnArr);
		var tit = DWRUtil.getValue("companyinfotitle");
		if(trim(tit).length==0){
			setMustWarn("companyinfotitleMust","请填写公司系统显示标题！"); 
			return false;
		}
		var entit = DWRUtil.getValue("companyinfoentitle");
		if(trim(tit).length==0){
			setMustWarn("companyinfoentitleMust","请填写公司系统显示英文标题！"); 
			return false;
		}
...
<body class="inputcls">
	<div class="formDetail">
		...
		<table  class="inputtable" border="0" style="width: 95%">
			...
			<tr>
			<th width="15%"><em> *</em>系统标题</th>
			<td>
			<input type="text" maxlength="50" id="companyinfotitle" value="<%=titname %>" style="width: 70%"/><label id="companyinfotitleMust"></label>
			</td>
			</tr>
			<tr>
			<th width="15%"><em> *</em>系统英文标题</th>
			<td>
			<input type="text" maxlength="90" id="companyinfoentitle" value="<%=titenname %>" style="ime-mode:disabled; width: 70%"/><label id="companyinfoentitleMust"></label>
			</td>
			</tr>
			<tr>

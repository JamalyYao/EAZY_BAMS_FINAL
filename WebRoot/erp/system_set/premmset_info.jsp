					...
					<table width="99%" cellpadding="4" cellspacing="0" border="0"
						...
						<tr>
							<td style="width: 12%; border-bottom: 1px solid #BDBCBC;"
								...
								<label for="chk_<%=levlMethod.getPrimaryKey()%>"><%=levlMethod.getMethodInfoName()%></label>
							</td>
								...
								<table width="100%" cellpadding="4" cellspacing="1" border="0"
									...
									<tr>
										<td style="width: 12%" nowrap="nowrap">
											...
											<label for="chk_<%=levlMethod2.getPrimaryKey()%>"><%=levlMethod2.getMethodInfoName()%></label>
										</td>
										<td>
											<table cellpadding="3" cellspacing="1" border="0"
												...
												<tr>
													...
													<td nowrap="nowrap">
														...
														<label for="chk_<%=levlMethod3.getPrimaryKey()%>"><%=levlMethod3.getMethodInfoName()%></label>
													</td>
													<%
														td++;
																						if (td > 0 && td % 5 == 0) {

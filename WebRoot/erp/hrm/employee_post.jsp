...
function delok(id){
	...
	MoveDiv.show('设置岗位','<%=contextPath%>/erp/hrm/employee_post_set.jsp?employeepks='+recordsPks);
}
...
<div id="leftPane">
	<div id="leftSplitterContainer">
		<div class="div_title_img">选择部门</div>
		<div id="leftTopPane" style="height:50%;">
			<jsp:include page="departmentxmlshow.jsp" flush="false">
				<jsp:param name="ischeck" value="true" />
			</jsp:include>
		</div>
		<div class="div_title_img">选择岗位</div>
		<div id="leftBottomPane" style="height:42%;">

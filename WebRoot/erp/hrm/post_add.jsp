...
function getPostUpid(){
	if(<%=pid%>!=null){
		var box = new Sys.msgbox('拾取上级岗位','<%=contextPath%>/erp/select_takepage/select_post.jsp?type=radio&textid=postupname&valueid=postupid&getup=code','700','450');
		box.msgtitle="<b>拾取上级岗位</b><br/>选择拾取上级岗位，不拾取请‘取消’";
		var butarray = new Array();
		butarray[0] = "ok|postclick('processloadfrm');";
		butarray[1] = "cancel";

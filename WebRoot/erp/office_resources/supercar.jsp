...
function dblCallback(obj){
 		//MoveDiv.show('车辆状态明细','<%=contextPath%>/erp/office_resources/car_detail.jsp?cid='+obj.value);
 		//var box = new Sys.msgbox('明细查看', '<%=contextPath%>/erp/office_resources/car_detail.jsp?cid='+obj.value, '750', '500');
	//box.msgtitle = "<b>车辆状态明细列表</b>";
	//box.show();
	openMDITab(window.parent.parent.parent,'<%=contextPath%>/erp/office_resources/car_detail.jsp?cid='+obj.value);
}
...
function modi(id){
	//MoveDiv.show('维护车辆',"<%=contextPath%>/erp/office_resources/car_mainten_add.jsp?pk="+id+'&url=office_resources/supercar.jsp');
	//Sys.load("<%=contextPath%>/erp/office_resources/car_mainten_add.jsp?pk="+id+'&url=office_resources/supercar.jsp');
	...
	url += "&nowwindow="+nowwindow
	openMDITab(window.parent.parent.parent,url);
}

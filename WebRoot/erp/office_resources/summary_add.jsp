...
function setPageValue(data){
 if(data != null){
      if(data.resultList.length>0){
          ...
          DWRUtil.setValue("oaMeetapplyAffix",meetapply.oaMeetapplyAffix);
          document.getElementById("oaMeetapplyDescribe").innerHTML = meetapply.oaMeetapplyDescribe;
          if(meetapply.oaMeetapplyAffix!=null){
          	document.getElementById("files").src ="<%=contextPath%>/erp/downloadtemp.jsp?fileids="+meetapply.oaMeetapplyAffix;
          }
	...
	<div class="formDetail">
			...
			<div>
				<table class="inputtable" border="0">
					...
					<th><em>* </em>指定读者</th>
					<td colspan="2">
					<textarea id="oaSummaryReader" readonly="readonly" onclick="selectEmps()" style="color: #999" must="读者不能为空" formust="oaSummaryReaderMust" linkclear="oaWorkplanEmps_s">双击选择</textarea>

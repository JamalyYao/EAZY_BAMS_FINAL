...
function dblCallback(obj){
	//var box = new Sys.msgbox('明细查看','<%=contextPath%>/erp/office_resources/meetSummary_detail.jsp?cid='+obj.value,'800','500');
		//box.msgtitle="<b>会议明细列表</b>";
		//box.show();
	//MoveDiv.show('查询会议明细','<%=contextPath%>/erp/office_resources/meetmanager_detail.jsp?cid='+obj.value);	

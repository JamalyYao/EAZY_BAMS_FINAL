...
function dblCallback(obj){
	var box = new Sys.msgbox('明细查看','<%=contextPath %>/erp/company_resources/photo_detail.jsp?pid='+obj.value+'&noid=1','900','600');
		...
		<td valign="top" style="height:100%">
			<table class="detailtable" align="center">
				...
				<tr>
					...
					<th>相片数量</th>
					<td id="count" class="detailtabletd"  colspan="1"> </td>
				<tr>
					<th>相册描述</th>

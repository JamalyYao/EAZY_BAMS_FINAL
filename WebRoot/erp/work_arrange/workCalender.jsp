	...
	<body style="overflow: hidden">
		...
		<table height="100%" width="100%" cellpadding="0" cellspacing="0"
					...
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td align='left' style='padding-left: 15px;' width="20px">
								<a title='上一天' onclick='init(-1)' href="javascript:void(0)"
									style="cursor: pointer; font: 12px '宋体'; text-decoration: none;">&nbsp;<<&nbsp;</a>
							</td>
							<td id="newdate" align='left' width="75px">
							</td>
							<td align='left' width="20px">
								<a title='下一天' onclick='init(1)' href="javascript:void(0)"
									style="cursor: pointer; font: 12px '宋体'; text-decoration: none;">&nbsp;>>&nbsp;</a>
							</td>
							<td style='padding-left: 30px;'>
								<btn:btn onclick="queryData()" value=" 今 日 " width="50px"></btn:btn>
							</td>
			...
			<tr style="height: 100%">
				<td valign="top">
					<div
						style="overflow: auto; height: 100%; border-top: 1px solid #D8D6D6; width: 100%">
			...
			<tr>
				<td>
					<div
						style="width: 30px; height: 80px; border: 1px; display: none">

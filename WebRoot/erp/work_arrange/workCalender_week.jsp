					...
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td align='left' style='padding-left: 15px;' width="20px">
								<a title='上一周' onclick='init(-7)' href="javascript:void(0)"
									style="cursor: pointer; font: 12px '宋体'; text-decoration: none;">&nbsp;<<&nbsp;</a>
							</td>
							<td id="newdate" align='left' width="75px">
							</td>
							<td align='left' width="20px">
								<a title='下一周' onclick='init(7)' href="javascript:void(0)"
									style="cursor: pointer; font: 12px '宋体'; text-decoration: none;">&nbsp;>>&nbsp;</a>
							</td>
							<td style='padding-left: 30px;'>
								<btn:btn onclick="setdate()" value=" 本 周 " width="50px"></btn:btn>
							</td>

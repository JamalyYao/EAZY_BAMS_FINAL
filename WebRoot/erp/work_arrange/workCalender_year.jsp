...
<html>
	<head>
		...
		<title>日程安排</title>
		<script type="text/javascript" src="<%=contextPath%>/js/functionjs/calenderjs.js"></script>
		<link rel='stylesheet' type="text/css" href="<%=contextPath%>/js/functionjs/calendercss.css" />
...
function dateback(data){
	if(data.success == true){
		...
		if(data.resultList.length > 0){
			...
			otr.id = calbean.time;
			otr.setAttribute("ondblclick",function(){addCalender(this);}); 
...
function addCalender(index){
	...
	//MoveDiv.show('新增\编辑日程安排','<%=contextPath%>/erp/work_arrange/workCalender_add.jsp?calendertype=1&startTime='+datetime);
	
	var url ='<%=contextPath%>/erp/work_arrange/workCalender_add.jsp?calendertype=1&startTime='+datetime;
	var nowwindow = window.parent.parent.parent.getNowWindow();
	window.parent.parent.parent.MDIOpen(url + "&nowwindow="+nowwindow);
}
	...
	<body style="overflow: hidden">
		<div id="functiondiv" style="display: none;">
			<div onmouseover="childover(this);"
				onmouseout="childout(this,'functiondiv');"
				style="background-repeat: no-repeat; background-position: 3px 1px; background-image: url('<%=contextPath%>/images/grid_images/info.png');">
				完成
			</div>
			<div onmouseover="childover(this);"
		...
		<table height="100%" width="100%" cellpadding="0" cellspacing="0"
			...
			<tr style="width: 100%">
				<td style="padding-bottom: 5px; padding-top: 5px;">
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td align='left' style='padding-left: 15px;' width="20px">
								<a title='上一年' onclick='init(-1)' href="javascript:void(0)"
									style="cursor: pointer; font: 12px '宋体'; text-decoration: none;">&nbsp;<<&nbsp;</a>
							</td>
							<td id="newdate" align="center" width="55px">
							</td>
							<td align='left' width="20px">
								<a title='下一年' onclick='init(1)' href="javascript:void(0)"  
									style="cursor: pointer; font: 12px '宋体'; text-decoration: none;">&nbsp;>>&nbsp;</a>
							</td>
							<td style='padding-left: 30px;'>
								<btn:btn onclick="setdate()" value=" 今 年 " width="50px"></btn:btn>
							</td>
							<td style="padding-right: 20px" align="right">
								<select onchange="getView()" id="view">
									<option value="1">
										日列表
									</option>
									<option value="2">
			...
			<tr style="height: 100%">
				<td valign="top">
					<div
						style="overflow: auto; height: 100%; border-top: 1px outset #ffffff; width: 100%">
						<sys:table tableTitle="年列表" width="100%" id="resultTable">
							<td class='tableTitle1' width="70" id="time" nowrap="nowrap">
								时间
							</td>
							<td class='tableTitle1' id="value">
								内容
							</td>
						</sys:table>
					</div>

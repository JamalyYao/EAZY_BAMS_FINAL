...
function exportWord(id){
	dwrOaNewsService.exportAnnounce(id,exportCallback);
}

function exportCallback(data){
    if(data.success){
		confirmmsgAndTitle("生成word成功！","downloadFile()","下载文件","","关闭");
	}else{
		alertmsg(data);
	}
}
...
function downloadFile(){
	window.location.href= "<%=contextPath %>/downloadfile/<%=ExportWord.ANNOUNCE_FILE_NAME%>";
}

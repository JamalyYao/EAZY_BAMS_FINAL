...
function splitTitle(){
  if(isSplit==0){
  var splitStar=DWRUtil.getValue("helpTitle");
  dwrSysProcessService.getSearchContentSplit(splitStar,getdate);
  isSplit=1;
  }
}
...
function getdate(data){
    if(data.success && data.resultList.length>0){
          var helpdate = data.resultList[0];
          DWRUtil.setValue("helpKeyword",helpdate);
	  }
}
...
<fieldset>
	...
	<input type="text" onclick="reSet()" id="helpTitle" must="帮助标题不能为空" formust="helpTitleMust" value="" style="width: 90%" maxlength="50">
	<br/>
	...
	<input type="text"  onclick="splitTitle();" id="helpKeyword" must="关键字不能为空" formust="helpKeywordMust" value="" style="width: 90%;" maxlength="50">
	<br/>

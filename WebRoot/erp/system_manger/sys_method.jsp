...
function add(){
	Sys.MDIOpen("<%=contextPath%>/erp/system_manger/sys_method_add.jsp?nowwindow="+Sys.getWindow());
}

function edit(pk){
	Sys.MDIOpen("<%=contextPath%>/erp/system_manger/sys_method_edit.jsp?sid="+pk+"&nowwindow="+Sys.getWindow());
}

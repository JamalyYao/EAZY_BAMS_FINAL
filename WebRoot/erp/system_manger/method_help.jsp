...
function replaceHelpImg(rowObj){
	var str = "<无>";
	if(Sys.isNotBlank(rowObj.helpImg)){
...
function add(){
	...
	var nowwindow = window.parent.parent.getNowWindow();
	window.parent.parent.MDIOpen(url + "?nowwindow="+nowwindow);
}
</script>
</head>
<body>
<%
    ...
    sccList.add(new SysColumnControl("helpDesc","操作提示内容",1,2,2,0));

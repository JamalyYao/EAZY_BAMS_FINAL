...
<body style="background-color:transparent;cursor: default;" title="单击选择图片上传" >
...
<div style="border:0px solid #ededed;position: absolute;top:0px;visibility:hidden;" id="butt">
...
<a href="javascript:void(0);" class="files" title="选择图片上传"><input id="upfile" name="upfile" type="file" onchange="fileSend(this);"></a>&nbsp;&nbsp;
</div>
</td>
</tr>
</table>

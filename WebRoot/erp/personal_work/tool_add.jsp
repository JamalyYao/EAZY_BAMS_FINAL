...
window.onload = function(){
	...
	useLoadingMassage();
	initInput("helpTitle","您可以创建属于自己的工具，路径格式为:'http://www.eazytec.com'");
	saveOrEdit();
}
	
function saveOrEdit(){
	if(<%=toolid%> != null){
		dwrPersonalOfficeSerivce.getToolByTypeAndPk(<%=typePk%>,<%=toolid%>,setOaToolinfo);
 	}
}
...
function save(){
	...
	if (bl){
		...
		dwrPersonalOfficeSerivce.addTool(getToolInfo(),image,saveCallback);
		Btn.close();
	}
}

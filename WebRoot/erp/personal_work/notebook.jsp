...
function queryData(){
	...
	var pager = getPager();
	dwrPersonalOfficeSerivce.listNotebook(Notebook,pager,queryCallback);
}
...
function deleNotebook(){
    ...
    dwrPersonalOfficeSerivce.deleteNotebookById(recordsPks,deleback);
}
...
function delok(pk){
    var ids = new Array();
    ids[0] = pk;
    dwrPersonalOfficeSerivce.deleteNotebookById(ids,deleback);
}

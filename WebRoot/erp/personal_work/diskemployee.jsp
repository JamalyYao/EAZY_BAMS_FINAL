...
function repleaCol(rowObj){
	...
	var bc = s*vl;
	str="<label style='width:"+vl+"px;' class='divbgcol'><span style='width:"+bc+"px;' class='divspan4'></span></label>";
	str+="&nbsp;&nbsp;<font style='font:12px 宋体'>"+rowObj.usedSpace+"/"+(rowObj.totalSpace-rowObj.usedSpace)+"</font>";
	return str;
}
</script>
</head>

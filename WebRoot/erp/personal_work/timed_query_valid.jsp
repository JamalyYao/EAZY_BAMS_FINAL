...
function queryData(){
	...
	var pager = getPager();
	dwrPersonalOfficeSerivce.getTimedValidByCompanyAndEmpId(timed,pager,queryCallback);
}
...
function delbatchok(){
    ...
    dwrPersonalOfficeSerivce.deleteTimedRecordByPks(recordsPks,setcallback);
}
...
function delok(id){
	var ids = new Array();
	ids[0] = id;
	dwrPersonalOfficeSerivce.deleteTimedRecordByPks(ids,setcallback);
}

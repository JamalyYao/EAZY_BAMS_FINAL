...
<div style="font-size: 16px;font-family: Microsoft YaHei, 宋体, Segoe UI, verdana, arial;color: #fefefe">欢迎注册卓易基础应用管理平台！请填写相关申请信息或者访问<a href="http://www.eazytec.com" target="_blank" class="regtit">官方网站</a>获取更多信息。</div>
</td>
		 ...
		 <table width="730" cellpadding="0" cellspacing="0" border="0">
            ...
            <td>
              ...
              <ul style="line-height: 30px;color: #333333;font-size: 13px;">
				...
				<li>如还有其他疑问，可访问<a href="http://www.eazytec.com" target="_blank" style="color: rgb(19,112,171)">官方网站</a>获取更多信息。</li>
			  </ul>
            </td>
          </tr>
         <tr>
